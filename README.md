...
2. To sync your code with our code along, let's make this project a repo and link to the code-along's remote:
```
git init
```
add the remote:
```
git remote add origin https://git.generalassemb.ly/msiller455/mongoose-movies-SEIR-2-22.git
```

3. Sync your code with the remote:
